...
public class GenerateTest {
    ...
    public static void main(String[] args) {
        ...
        //配置项目路径
        String projectPath = System.getProperty("user.dir"); //aigou-parent的根目录
        //加载配置文件
        ...
        pc.setParent("cn.itsource.gogou");
        pc.setEntity("domain");
        ...
        //生成哪些表的代码
        //strategy.setInclude("t_product_comment","t_product","t_product_ext","t_sku","t_specification");
        strategy.setInclude("t_product");
